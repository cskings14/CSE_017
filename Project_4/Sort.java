...
public class Sort {
    ...
    // iterations[6] = is iterations for bucket sort
    // iterations[7] = is iterations for radix sort
    ...
    public static <E extends Comparable<E>> void bucketSort(ArrayList<E> list){
        itertaions[6] = 0;
        ArrayList<E>[] buckets = new ArrayList[list.size()];
        ...
        for (int i = 0; i < list.size(); i++){
            itertaions[6]++;
            buckets[(int) (list.get(i).hashCode() % buckets.length)].add(list.get(i));
        }
        for (int i = 0; i < buckets.length; i++){
            itertaions[6]++;
    ...
    public static <E extends Comparable<E>> void radixSort(ArrayList<E> list){
        itertaions[7] = 0;
        radixSort(list, list.size());
    }

    private static <E extends Comparable<E>> void radixSort(ArrayList<E> list, int n){
        itertaions[7]++;
        if (n < 2){
            return;
        }
